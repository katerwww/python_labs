...
current_dir = os.path.dirname(os.path.abspath(__file__))  # папка src/lab04
...
def main(file: str, encoding: str = "utf-8"):
    ...
    )  # сортирует список, критерии сортировки, частота слово и само слово, сортировка по убыванию
    report_path = (
        file_path.parent / "report.csv"
